  ...
  return (
    <div className="bg-gradient-to-b from-purple-800 to-purple-50 flex flex-col pt-16">
      <div className="container mx-auto pb-20">
        ...
        >
          <div className="bg-purple-100 pt-10 w-full rounded-lg shadow-lg mt-20">
            <div className="flex items-center flex-col space-y-5">
              <UnDrawMoon className="h-auto w-2/3 lg:w-1/3" />
              <div className="font-bold text-4xl">About the Guild</div>
              <div className="font-medium text-purple-600 text-lg pl-20 pr-20 pb-10">
        ...
        >
          <div className="flex lg:space-x-5 mt-10 flex-col lg:flex-row lg:space-y-0 space-y-5">
            ...
            <div className="bg-purple-100 p-5 flex-1 rounded-lg shadow-lg">
              ...
              <div className="font-medium text-center pt-2">Heroic: 7/10</div>
            </div>
          </div>
        </motion.div>

        <div className="bg-purple-100 pt-10 rounded-lg shadow-lg mt-10 w-1/2 mx-auto">
